...
class OpenAIChatModelName(StrEnum):
    gpt_4o_mini = "gpt-4o-mini"


class OpenAIChatConfig(BaseModel):
    model: OpenAIChatModelName = Field(..., description="Model name to use.")
...
OPENAI_CHAT_CONFIG_DEFAULT = OpenAIChatConfig(
    model=OpenAIChatModelName.gpt_4o_mini,
    temperature=0.2,
